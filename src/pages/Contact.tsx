        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[80px] items-start mt-[40px]">
          ...
          <FadeIn className="md:pr-[80px] md:border-r border-ink/5">
            ...
            <p className="text-[14.5px] text-ink/70 leading-[1.9] mt-[12px] mb-[40px]">
              This website is an information resource — for product education, ingredient science, and system guidance. To purchase or enquire, reach out through the channels below.
            </p>
            ...
            <div className="mt-[16px] font-mono text-[9px] tracking-[1px] text-ink/40 pt-[14px] border-t border-ink/5">
              Information website only — products are not sold here.
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.2} className="md:pl-[80px]">
            <div className="bg-cream p-[40px] border border-ink/5 relative overflow-hidden">
              ...
              <div className="font-mono text-[10px] uppercase tracking-[3px] text-gold mb-[24px]">Clinical Partnerships</div>
              <h3 className="font-serif text-[28px] text-ink mb-[8px] leading-tight">Become a Partner Clinic</h3>
              <p className="text-[13px] text-ink/60 mb-[32px] leading-relaxed">
                Rejo Derma operates exclusively through certified dermatology clinics and authorized aesthetic centers. Submit your details for our onboarding protocol.
              </p>

              {formStatus === 'success' ? (
                <div className="py-[40px] text-center border border-sage/30 bg-sage/5">
                  <div className="w-[48px] h-[48px] rounded-full bg-sage/10 text-sage flex items-center justify-center mx-auto mb-[16px]">✓</div>
                  <h4 className="font-serif text-[20px] text-ink mb-[8px]">Inquiry Received</h4>
                  <p className="text-[13px] text-ink/60">Our clinical team will review your application and respond within 48 hours.</p>
                </div>
              ) : (
